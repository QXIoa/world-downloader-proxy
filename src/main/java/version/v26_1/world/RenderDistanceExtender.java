...
public class RenderDistanceExtender {
    ...
    public void updatePlayerPos(Coordinate2D newPos) {
        ...
        // TODO: for 1.21+, fix client unable to read chunk data packets generated by downloader
        // for some reason. This is disabled for all supported versions (26.x) until the
        // underlying issue is fixed. The original logic (below, commented out) should be
        // re-enabled once the chunk packet format mismatch is resolved.
        //
        ...
        //         if (!oldPos.isInRangeManhattan(newChunkPos, 2)) { delay(); }
    ...
    private void sendNewRenderDistancePacket(int newDistance) {
        ...
        VersionAccessors.injector().enqueuePacket(pb);
    }
