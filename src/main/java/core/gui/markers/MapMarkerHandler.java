...
public class MapMarkerHandler {
    ...
    public void draw(Bounds bounds, double blocksPerPixel, GraphicsContext graphics, Coordinate2D cursorPos) {
        ...
        graphics.fillOval(markerX - markerSize / 2.0, markerZ - markerSize / 2.0, 8, 8);
        graphics.setStroke(Color.BLACK);
        graphics.strokeOval(markerX - markerSize / 2.0, markerZ - markerSize / 2.0, 8, 8);
    }
}
