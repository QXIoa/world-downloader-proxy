...
public class SelectionState {
    ...
    public void setPos1(Coordinate3D pos, Dimension dim) {
        setCorner(pos, dim, true);
    }

    public void setPos2(Coordinate3D pos, Dimension dim) {
        setCorner(pos, dim, false);
    }

    private void setCorner(Coordinate3D pos, Dimension dim, boolean isFirstCorner) {
